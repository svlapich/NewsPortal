...
function drawPosts(posts) {
  ...
  for (var i = 0; i < 5; i++) {
    ...
    if (post.attachments[0]['photo']) {
      htmlFields += '<div class="mdl-grid mdl-cell mdl-cell--12-col-desktop mdl-cell--9-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--4dp">\n' +
        ...
        '            <h2 class="mdl-card__title-text mdl-card--expand">Features</h2>\n' +
