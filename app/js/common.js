...
function drawPosts(postImage, postTitle, postText, hashTag, postCode) {
  ...
  card.innerHTML =
    ...
    '           </div>\n' +
    ' </div>\n';
  content = document.getElementById("content").appendChild(card);
  card.addEventListener('click', function() {
    getArticle(postImage, postTitle, postText, hashTag);
  }, false);
}
...
function getArticle(postImage, postTitle, postText, hashTag) {
  var newArticle =
    ' <div><button onclick="goBackToMain()" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">Back</button></div>\n' +
